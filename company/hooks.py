...
website_route_rules = [
    {"from_route": "/", "to_route": "crm_entry"},
    {"from_route": "/crm", "to_route": "crm_entry"},
    {"from_route": "/user", "to_route": "crm_entry"},
    {"from_route": "/contacts", "to_route": "crm_entry"},
    {"from_route": "/accounts", "to_route": "crm_entry"},
    {"from_route": "/deals", "to_route": "crm_entry"},
    {"from_route": "/events", "to_route": "crm_entry"},
    {"from_route": "/calls", "to_route": "crm_entry"},
    {"from_route": "/meetings", "to_route": "crm_entry"},
    {"from_route": "/products", "to_route": "crm_entry"},
    {"from_route": "/blog", "to_route": "crm_entry"},
    {"from_route": "/reports/<path:app_path>", "to_route": "crm_entry"},
    {"from_route": "/sign-in", "to_route": "crm_entry"},
]
